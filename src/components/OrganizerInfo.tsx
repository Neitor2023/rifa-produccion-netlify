...
const OrganizerInfo: React.FC<OrganizerInfoProps> = ({ organization }) => {
  return (
    <div className="mb-8">
      <h2 className="text-lg font-semibold mb-4 text-gray-800">Organizadores:</h2>
        ...
        <Card className="bg-white">
          <CardContent className="p-4">
            <div className="flex items-center gap-4">
              ...
              />
              <div>
                <h3 className="font-medium text-gray-800">{organization.org_name}</h3>
                <div className="flex items-center text-gray-600 text-sm mt-1">
                  <Phone className="h-4 w-4 mr-1" />
                  <span>{organization.org_phone_number}</span>
                </div>
                <p className="text-xs text-gray-500 mt-1">Organizador</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-white">
          <CardContent className="p-4">
            <div className="flex items-center gap-4">
              ...
              />
              <div>
                <h3 className="font-medium text-gray-800">{organization.admin_name}</h3>
                <div className="flex items-center text-gray-600 text-sm mt-1">
                  <Phone className="h-4 w-4 mr-1" />
