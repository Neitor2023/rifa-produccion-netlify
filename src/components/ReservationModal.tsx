            ...
            <Card className="bg-[#9b87f5] dark:bg-[#7E69AB] shadow-md border-0">
              <CardHeader className="py-3 px-4">
                <DialogTitle className="text-xl text-white font-bold text-center">
                  Apartar númerosXYZ--X
                </DialogTitle>
                <DialogClose className="absolute - right-10 center rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none text-black-600 dark:text-black-300">
                  <X className="h-4 w-4" />
