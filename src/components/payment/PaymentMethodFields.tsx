        ...
        render={({ field }) => (
          <FormItem>
            <FormControl>
              ...
              >
                <SelectTrigger className="text-foreground bg-gray-50 dark:bg-gray-900 border-gray-300 dark:border-gray-700">
                  <SelectValue placeholder="Seleccione un método de pago" className="text-foreground" />
                </SelectTrigger>
