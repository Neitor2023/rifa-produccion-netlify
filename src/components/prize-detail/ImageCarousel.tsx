...
const ImageCarousel: React.FC<ImageCarouselProps> = ({ 
  ...
  return (
    <>
      ...
      <div className="block md:hidden text-center text-sm font-medium text-gray-700 dark:text-gray-300 mb-4 px-2">
        <p>Deslice hacia los lados para ver más imágenes</p>
        <p>Deslice hacia abajo para ver más detalles</p>
      </div>
  
      {/* Carrusel visible solo en pantallas medianas en adelante */}
